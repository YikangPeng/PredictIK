...
namespace Animancer.Examples.StateMachines.Characters
{
    ...
    /// </summary>
    /// <example>
    ///     <see href="https://kybernetik.com.au/animancer/docs/examples/fsm/characters">Characters</see>
    /// </example>
    ...
    public sealed class Character : MonoBehaviour
    {
        ...
        public readonly StateMachine<CharacterState>.WithDefault StateMachine = new StateMachine<CharacterState>.WithDefault();
        ...
        /// </summary>
        public void TrySetState(CharacterState state)
        {
        ...
        private void AfterInspectorGUI()
        {
            if (EditorApplication.isPlaying)
                ...
                {
                    EditorGUILayout.ObjectField("Current State", StateMachine.CurrentState, typeof(CharacterState), true);
                }
        }
